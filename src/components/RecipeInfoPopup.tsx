...
const RecipeInfoPopup = ({usedIngredients, missingIngredients}: RecipeInfoPopupProps) => {
  ...
  return (
    <div onClick={(e) => e.stopPropagation()} className="dropdown dropdown-top dropdown-hover">
  ...
  <div tabIndex={0} className="card compact dropdown-content z-[1] shadow bg-amber-50 rounded-box w-64">
